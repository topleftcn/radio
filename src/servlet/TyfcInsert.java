...
@WebServlet("/tyfcinsert.do")
@MultipartConfig(location="/tmp",fileSizeThreshold=1024)
public class TyfcInsert extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Tyfc t = new Tyfc(Integer.parseInt(type), title, content, picture, inserttime);
		int index = new TyfcDAO().TyfcInsert(t);
		if( index > 0){
