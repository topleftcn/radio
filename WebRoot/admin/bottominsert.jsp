...
<div class="container clearfix">
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="/radio/songset.do"><i class="icon-fmont">&#xe004;</i>点歌台内容设置</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>首页<span class="crumb-step">&gt;</span>新增内容<span class="crumb-step">&gt;</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
            <form action="/radio/bottominsert.do" method="post">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        		<tr>
                                <th>年份:</th>
                                <td>
								<textarea name="year" id= "c" style="width:600px;height:20px;">${allbottom[0].year }</textarea>
								</td>
                            </tr>
                        	<tr>
                                <th>联系人:</th>
                                <td>
								<textarea name="phonenumber" id= "c" style="width:600px;height:30px;">${allbottom[0].phonenumber }</textarea>
								</td>
                            </tr>
                            <tr>
                                <th>ABOUT ERACLE:</th>
                                <td>
								<textarea name="about" id= "cc" style="width:600px;height:100px;">${allbottom[0].about }</textarea>
								</td>
                            </tr>
                            <tr>
                                <th>TWITTER:</th>
                                <td>
								<textarea name="twittwr" id= "ccc" style="width:600px;height:100px;">${allbottom[0].twittwr} </textarea>
								</td>
                            </tr>
                            <tr>
                                <th></th>
