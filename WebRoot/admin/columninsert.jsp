...
<div class="container clearfix">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="indexset.jsp"><i class="icon-font">&#xe008;</i>首页内容设置</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>首页<span class="crumb-step">&gt;</span>新增节目指南<span class="crumb-step">&gt;</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="http://localhost:8080/radio/columninsert.do" method="post">
                        ...
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <tr>
                                <th><i class="require-red"></i>播出时间：</th>
                                <td>
                                    <input class="common-text required" id="time" name="columntime" size="50" value="" type="text">
                                </td>
                            </tr>                     
                            <tr>
                                <th>栏目内容：</th>
